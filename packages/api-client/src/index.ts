...
export function createApiClient(options: ClientOptions) {
  ...
  return {
    ...
    tiktokConnections: () => request("/api/v1/integrations/tiktok"),
    connectTikTok: (input: { appId: string; advertiserId: string; pageId: string; accessToken: string; appSecret: string }) => request("/api/v1/integrations/tiktok/connect", { method: "POST", body: JSON.stringify(input) }),
    checkTikTok: (id: string) => request(`/api/v1/integrations/tiktok/${encodeURIComponent(id)}/check`, { method: "POST" }),
    disconnectTikTok: (id: string) => request(`/api/v1/integrations/tiktok/${encodeURIComponent(id)}/disconnect`, { method: "POST" }),
    metaConnections: () => request("/api/v1/integrations/meta"),
    connectMeta: (body: Record<string, string>) => request("/api/v1/integrations/meta/connect", { method: "POST", body: JSON.stringify(body) }),
    activateMeta: (id: string) => request(`/api/v1/integrations/meta/${encodeURIComponent(id)}/activate`, { method: "POST" }),
    disconnectMeta: (id: string) => request(`/api/v1/integrations/meta/${encodeURIComponent(id)}/disconnect`, { method: "POST" }),
    googleConnections: () => request("/api/v1/integrations/google"),
    connectGoogle: (kind: string, resourceId?: string) => request("/api/v1/integrations/google/connect", { method: "POST", body: JSON.stringify({ kind, resourceId }) }),
    disconnectGoogle: (id: string) => request(`/api/v1/integrations/google/${encodeURIComponent(id)}/disconnect`, { method: "POST" }),
    syncGoogle: (id: string) => request(`/api/v1/integrations/google/${encodeURIComponent(id)}/sync`, { method: "POST" }),
    googleFormQuestions: (id: string) => request(`/api/v1/integrations/google/${encodeURIComponent(id)}/questions`),
    saveGoogleFormMapping: (id: string, body: Record<string, string>) => request(`/api/v1/integrations/google/${encodeURIComponent(id)}/mapping`, { method: "PATCH", body: JSON.stringify(body) }),
