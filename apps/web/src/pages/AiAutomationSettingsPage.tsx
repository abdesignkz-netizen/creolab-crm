    ...
    <section>
      <div className="page-head">
        <div>
          ...
          <h2>Новые заявки</h2>
          <p className="muted">Как обрабатывать новые заявки. Уже запущенные задачи не меняются. Текст ответов WhatsApp задаёт администратор сервиса в промте и базе знаний.</p>
        </div>
      </div>
