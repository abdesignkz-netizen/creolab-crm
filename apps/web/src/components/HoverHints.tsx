...
const ACTION_HINTS: Record<string, string> = {
  ...
  "Описать своими словами": "Написать задачу своими словами — система разберёт, кому и что сделать",
  "Заполнить форму": "Создать задачу вручную: тип, клиент, срок, текст",
  "+ Новая задача": "Создать задачу: что сделать, к чему относится, кто выполнит, срок",
  "Мои": "Назначены на вас — не те, что вы поставили другим",
  "Сегодня": "Срок сегодня",
  "Запланированные": "Срок в будущем или запланированная отправка",
  "Просроченные": "Срок уже прошёл, задача ещё не завершена",
  "Завершённые": "Сделанные и отменённые задачи",
  "В работу": "Отметить, что задача сейчас выполняется",
