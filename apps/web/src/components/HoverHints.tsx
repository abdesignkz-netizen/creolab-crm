...
const ACTION_HINTS: Record<string, string> = {
  ...
  "Добавить заметку": "Сохранить как заметку со статусом «к выполнению»",
  ...
  "Сформировать Word": "Собрать договор в Word по выбранному шаблону — файл можно править до подписи",
  "Посмотреть договор": "Открыть сформированный Word в окне просмотра",
  ...
  "Скачать Word": "Скачать заполненный договор в Word",
