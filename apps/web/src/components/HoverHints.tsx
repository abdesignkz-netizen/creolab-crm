...
const ACTION_HINTS: Record<string, string> = {
  ...
  "Распознать шаблон": "Прочитать Word и заменить реквизиты сторон на поля шаблона",
  ...
  "Сформировать по шаблону": "Создать договор для выбранной компании: услуги, НДС и реквизиты подставятся в шаблон",
