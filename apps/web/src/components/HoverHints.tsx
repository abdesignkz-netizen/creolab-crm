...
const ACTION_HINTS: Record<string, string> = {
  ...
  "Забрать диалоги из бота": "Загрузить существующие диалоги из общего AI Manager в эту компанию. Нужна при первом подключении или если синхронизация отстала.",
