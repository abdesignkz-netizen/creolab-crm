...
export const INTEGRATION_IMPLEMENTATIONS: IntegrationImplementation[] = [
  ...
  },
  {
    ...
    purpose: "Отдельный бот компании: входящие личные сообщения, вложения и ответы сотрудников.",
    functions: ["receive_messages", "send_text", "send_media"],
    authMethod: "bot_token",
    implementationReady: true,
    multiple: true,
    fields: [],
    connectable: false,
    connectHint: "Подключите бота через раздел «Интеграции» в кабинете компании.",
  },
  {
  ...
  },
  {
    type: "calendar",
    title: "Календарь",
    purpose: "События договорённостей CRM в Google Calendar.",
    ...
    fields: [],
    connectable: false,
    connectHint: "Подключается в разделе «Интеграции» выбранной компании.",
  },
  {
    type: "instagram_direct",
    title: "Instagram Direct",
    purpose: "Сообщения Instagram и текстовые ответы из CRM.",
    functions: ["receive_messages", "send_text"],
    authMethod: "token",
    implementationReady: true,
    multiple: true,
    fields: [],
  ...
  },
  {
    ...
    purpose: "Заявки из форм Meta с защитой от дубликатов.",
    functions: ["receive_leads"],
    authMethod: "token",
    implementationReady: true,
    multiple: true,
    fields: [],
  ...
  },
  {
    type: "google_forms",
    title: "Google Forms",
    purpose: "Заявки Google Forms и сопоставление полей.",
    functions: ["receive_leads"],
    authMethod: "oauth",
    implementationReady: true,
    multiple: false,
  ...
  },
  {
    type: "tiktok_leads",
    title: "TikTok Leads",
    purpose: "Заявки TikTok Instant Forms с проверкой доступа.",
    functions: ["receive_leads"],
    authMethod: "token",
    implementationReady: true,
    multiple: true,
  ...
  },
  {
    type: "email",
    title: "Email",
    purpose: "Входящие письма Gmail в диалогах CRM.",
    functions: ["receive_messages", "receive_media"],
    authMethod: "oauth",
    implementationReady: true,
    multiple: false,
    fields: [],
