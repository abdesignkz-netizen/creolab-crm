...
export const ESF_CERTIFICATE_NOT_VALID_USER_MESSAGE =
  "ИС ЭСФ не приняла сертификат. На тестовом стенде КГД принимает собственные действующие сертификаты НУЦ: AUTH_RSA для входа и ключ подписи (GOST для ЮЛ) для АВР. Зарегистрируйте организацию на test3.esf.kgd.gov.kz и в NCALayer не путайте ключ входа с ключом подписи.";
