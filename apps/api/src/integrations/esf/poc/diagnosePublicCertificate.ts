import { extractBin, extractIin, inspectCertificatePem, inspectCertificateUsage, normalizeCertificatePem } from "../../../services/cmsInspect.ts";
...
export function diagnosePublicCertificate(
  ...
  const usage = inspectCertificateUsage(normalized);
  ...
  return {
    ...
    signatureAlgorithm: usage.signatureAlgorithm,
    caEnvironment: env,
    x509Format: {
